    ...
    <section id="about" className="text">
      ...
      <div className="about-text">
        <p>
          ...
          <br />
          <br />
          While my career path has shifted, my passion for problem-solving
          remains unwavering. I&apos;m driven by the opportunity to tackle
          complex challenges and create innovative solutions.
        </p>
      </div>
    </section>
  )
